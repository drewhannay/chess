...
public class HelpFrame extends JFrame {
	...
	private void initGUIComponents() {
		...
		helpTypesTabbedPane.addTab("General Help", null, generalHelpPanel,
				"Click for General Help with " + AppConstants.APP_NAME);
		helpTypesTabbedPane.addTab("Game Play Help", null, gamePlayHelpPanel,
				"Click for help playing Chess");
		helpTypesTabbedPane.addTab("Variant Creation Help", null,
				variantMakingHelpPanel, "Click for help making a new Variant");
		helpTypesTabbedPane.addTab("Piece Making Help", null,
				pieceMakingHelpPanel, "Click for help making new Game Pieces");

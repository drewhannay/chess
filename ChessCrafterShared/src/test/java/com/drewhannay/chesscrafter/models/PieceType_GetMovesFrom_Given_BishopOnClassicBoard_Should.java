...
public class PieceType_GetMovesFrom_Given_BishopOnClassicBoard_Should {
    ...
    public void return2_2For1_1() {
        Set<ChessCoordinate> moves = mTarget.getMovesFrom(ChessCoordinate.at(1, 1), mBoardSize, 0);
        assertTrue(moves.contains(ChessCoordinate.at(2, 2)));
    }

    @Test
    public void return1_1For2_2() {
        Set<ChessCoordinate> moves = mTarget.getMovesFrom(ChessCoordinate.at(2, 2), mBoardSize, 0);
        assertTrue(moves.contains(ChessCoordinate.at(1, 1)));
    }

    @Test
    public void return2_1For1_2() {
        Set<ChessCoordinate> moves = mTarget.getMovesFrom(ChessCoordinate.at(1, 2), mBoardSize, 0);
    ...
    public void return8_1For1_8() {
        Set<ChessCoordinate> moves = mTarget.getMovesFrom(ChessCoordinate.at(1, 8), mBoardSize, 0);

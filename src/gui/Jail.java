...
/**
 * @author Cheney Hester, Yelemis, Drew, and Alisa This helps to make the Jail
 * which is where pieces are placed when they are removed from the board being
 * "taken". This could be used for variants where pieces can be replaced back
 * onto the board from this Jail.
 * 
 */
public class Jail implements Serializable
{
	...
	public Jail(int rows, int cols)
	{
		...
		for (int row = 0, col = 0; row < rows; row++)
		{
			...
			{
				// Initialize the Squares. Add one to the row and col to ignore
				// counting from zero.
	...
	/**
	 * @return the Largest row of the board. (The largest because there could be
	 * two boards.)
	 */

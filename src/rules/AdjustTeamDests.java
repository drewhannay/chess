 ...
 * 
 * Class to hold methods affecting the legal destinations for 
 * an entire team of pieces.
 * 
...
public class AdjustTeamDests implements Serializable {
	...
	/**
	 * Perform the method; using reflection
	 * to simulate polymorphic method invocation.
	...
	/**
	 * Adjust the available destinations if the player
	 * has chosen to play a variant where captures are 
	 * mandatory.
	 * @param team The team to adjust.
	 */
